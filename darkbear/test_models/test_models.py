...
class Tester:
    ...
    def __init__(self, command: str, suspicious_message: Dict, os_name: str = "Ubuntu"):
        self.command = self.command_to_std_command(command)
        self.suspicious_message = suspicious_message
        self.os_name = os_name
    

    def test(self, ssh_chanel, delay:int = 3):
        """
            write your rule of test like this:
            ```
    ...
    def command_to_std_command(self, command: str) -> str:
        """
        edit normal command to standard
        """
